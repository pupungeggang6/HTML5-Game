...
function drawSceneGLInit() {
    ...
    gl.uniformMatrix4fv(varGL.location.camera, false, glOrthoMatrix(-1.6, 1.6, -1, 1, 0.1, 2.1))
    gl.texImage2D(gl.TEXTURE_2D, 0, gl.RGBA, gl.RGBA, gl.UNSIGNED_BYTE, texture.player)
    gl.bindBuffer(gl.ARRAY_BUFFER, varGL.buffer.vertex)
    gl.bufferData(gl.ARRAY_BUFFER, new Float32Array([0, 0, 1, 0.5, 0, 1, 0.5, 0.5, 1, 0.5, 0.5, 1, 0, 0, 1, 0, 0.5, 1]), gl.STATIC_DRAW)
    gl.bindBuffer(gl.ARRAY_BUFFER, varGL.buffer.texture)
    gl.bufferData(gl.ARRAY_BUFFER, new Float32Array([0, 0, 0.5, 0, 0.5, 1, 0.5, 1, 0, 0, 0, 1]), gl.STATIC_DRAW)
    gl.drawArrays(gl.TRIANGLES, 0, 6)
    gl.bindBuffer(gl.ARRAY_BUFFER, varGL.buffer.vertex)
    gl.bufferData(gl.ARRAY_BUFFER, new Float32Array([0.5, 0, 1, 1, 0, 1, 1, 0.5, 1, 1, 0.5, 1, 0.5, 0, 1, 0.5, 0.5, 1]), gl.STATIC_DRAW)
    gl.bindBuffer(gl.ARRAY_BUFFER, varGL.buffer.texture)
